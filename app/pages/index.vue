  ...
  <div :class="$style.page">
    ...
    <main :class="$style.main">
      ...
      <About
        ...
        :image-max-width="600"
        title="Я - Данил"
        profile-image="images/about/profile-2.webp"
      >
        Дипломированный специалист по массажу и СПА-процедурам. Моя техника ориентирована на антицеллитный и лимфодренажный массаж, а также на медовый массаж с обёртыванием - идеальное решение для тех, кто хочет сбросить вес и вернуть телу лёгкость.
        <br>
        <br>
        В работе я соединяю точность и заботу, чтобы каждая процедура стала не просто уходом, но и гармоничным ритуалом для тела и души. Ваша практика красоты и здоровья начинается здесь: внимательное отношение к деталям, индивидуальный подход и комфорт уютного кабинета.
        <br>
        <br>
        Записывайтесь ко мне на процедуры, всегда рад вас видеть и жду Вас в уютном кабинете!
      </About>
...
import { type MenuItem } from '@/components/pages/index/components/navigation/index.vue'
import { type LinkItem } from '@/components/common/links-list/index.vue'
import { type ServiceItem } from '~/components/pages/index/components/service-item/index.vue'
import { type ContactItem } from '@/components/pages/index/components/contact-info-item/index.vue'
...
const gallery = [
  'images/gallery/IMG_7267.webp',
  'images/gallery/IMG_7268.webp',
  'images/gallery/IMG_7269.webp',
  'images/gallery/IMG_7270.webp',
  'images/gallery/IMG_7271.webp',
  'images/gallery/IMG_7272.webp',
  'images/gallery/IMG_7273.webp',
  'images/gallery/IMG_7274.webp',
  'images/gallery/IMG_7275.webp',
  'images/gallery/IMG_7276.webp',
  'images/gallery/IMG_7277.webp',
]
