<template>
  <div :class="$style.page">
    ...
    <main :class="$style.main">
      ...
      >
        Это я - Родион, занимаюсь массажем уже более 3 лет. Недавно переехал в Петербург и решил, что здесь тоже стоит радовать людей качественным массажем (поверьте, мама не врет!). 
        <br><br>
        Прошел курсы массажа от настоящего мастера своего дела, доктора медицинских наук, и продолжаю развиваться, добавляя в свои сеансы авторские фишки, которые вам точно понравятся.
        <br>
        Моё кредо в жизни – делать всё с любовью и от души. Так и массаж: я люблю то, что делаю, и делаю то, что люблю!
        <br><br>
        Всегда стараюсь сделать массаж не просто процедурой, а настоящим выражением любви и заботы.
        <br>
        Мягкий массажный стол, расслабляющая музыка, теплые пледы и, конечно, две моих нежных руки, которые помогут вам забыть обо всем!
      </About>
